...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'vOt1Qbd02GfRs5Fm', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/appmessage.css", // Project stylesheet file name
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2023\\appmessage\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2023\\appmessage\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-8a3f9354-b253-4c98-921b-87028b8af986", // Export folder
