 ...
 * Page class
 */
class SentTblDelete extends SentTbl
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SentTblDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "SentTblDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SentTblList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("SentTblList"); // Return to list
                return;
            }
        }
