...
/**
 * Table class for twilio_table
 */
class TwilioTable extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "[dbo].[twilio_table]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[twilio_table]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TwilioTableList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TwilioTableView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TwilioTableEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TwilioTableAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TwilioTableView";
            case Config("API_ADD_ACTION"):
                return "TwilioTableAdd";
            case Config("API_EDIT_ACTION"):
                return "TwilioTableEdit";
            case Config("API_DELETE_ACTION"):
                return "TwilioTableDelete";
            case Config("API_LIST_ACTION"):
                return "TwilioTableList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TwilioTableView", $parm);
        } else {
            $url = $this->keyUrl("TwilioTableView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TwilioTableEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TwilioTableList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TwilioTableAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TwilioTableList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TwilioTableDelete");
        }
    }
