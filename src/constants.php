...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "19.5.0");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "appmessage"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{8A3F9354-B253-4C98-921B-87028B8AF986}"); // Project ID
