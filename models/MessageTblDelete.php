 ...
 * Page class
 */
class MessageTblDelete extends MessageTbl
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MessageTblDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "MessageTblDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MessageTblList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MessageTblList"); // Return to list
                return;
            }
        }
